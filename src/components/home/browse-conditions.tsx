      ...
      <div className="mx-auto max-w-5xl px-5 py-20 sm:px-8 sm:py-24">
        <div className="rounded-3xl border border-harbor-mid/15 bg-canvas-alt p-6 sm:p-10">
          ...
          <h2 className="mt-3 max-w-xl font-display text-2xl font-extrabold text-harbor sm:text-3xl">
            A diagnosis doesn&apos;t have to close the door on coverage.
          </h2>
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-charcoal/70">
            Most families we talk to are surprised by how many conditions still
            qualify. Find yours below to see what&apos;s typical, or read the
            full guide to how carriers actually review health history.
          </p>
          ...
          >
            Read the full pre-existing conditions guide →
          </Link>
        </div>
      </div>
    </section>
