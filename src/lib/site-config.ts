...
export const siteConfig = {
  ...
  // branded domain name itself, not a separate LLC name (per direct confirmation).
  legalEntity: "FinalExpense.Support",
  domain: "finalexpense.support",
  ...
  supportEmail: "TODO@finalexpense.support",
