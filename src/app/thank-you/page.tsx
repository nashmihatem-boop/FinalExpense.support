...
export const metadata: Metadata = {
  ...
  openGraph: { title: "You're All Set — FinalExpense.support" },
  twitter: { title: "You're All Set — FinalExpense.support" },
};
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-xl flex-col items-center justify-center px-5 py-16 text-center">
      ...
      <p className="mt-4 max-w-md text-lg leading-relaxed text-charcoal/75">
        A licensed agent will call you at the number you provided to walk
        through your options, warmly and without pressure. In the meantime,
        keep an eye on your email for a copy of what you shared.
      </p>
      <p className="mt-3 max-w-md text-base text-charcoal/60">
        Need to talk to someone sooner? We&apos;re happy to hear from you.
      </p>
