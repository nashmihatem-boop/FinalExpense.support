...
export const metadata: Metadata = {
  title: "Final Expense Insurance Guides — Answers for Families",
  description:
    "Every guide on FinalExpense.support in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, explained gently.",
  openGraph: { title: "Final Expense Insurance Guides — Answers for Families", description: "Every guide on FinalExpense.support in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, explained gently." },

  twitter: { title: "Final Expense Insurance Guides — Answers for Families", description: "Every guide on FinalExpense.support in one place — coverage by state, pre-existing conditions, funeral costs, managing a policy, avoiding scams, and the basics of life insurance, explained gently." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
          Every answer, gathered in one caring place
        </h1>
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-charcoal/80">
          Final expense coverage touches more decisions than just a coverage
          amount, and we&apos;d rather you understood all of them than feel
          rushed into one. Browse by topic below, or jump straight to{" "}
        ...
        <div className="mx-auto mt-4 max-w-3xl">
          <LinkGroup title="The basics, explained gently" items={BASICS} />
          <LinkGroup title="Weighing your options" items={COMPARISONS} />
          <LinkGroup title="Planning ahead, and the harder questions" items={HARD_QUESTIONS} />
          <LinkGroup title="Wherever you are in life" items={BY_AGE} />
