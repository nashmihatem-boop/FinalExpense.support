      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
          <svg width="56" height="56" viewBox="0 0 48 48" fill="none">
            <path d="M4 32 Q24 6 44 32" stroke="#eaf6f7" strokeWidth="2.75" strokeLinecap="round" />
            <line x1="4" y1="34.5" x2="44" y2="34.5" stroke="#4f7f8c" strokeWidth="2.75" strokeLinecap="round" />
            <circle cx="24" cy="18.7" r="3.4" fill="#c99423" />
          </svg>
