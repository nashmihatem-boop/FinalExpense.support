...
export const metadata: Metadata = {
  ...
  description: "Who your information may be shared with when you submit a request on FinalExpense.support.",
  robots: { index: false, follow: true },
  openGraph: { title: "Our Network of Partners — FinalExpense.support" },
  twitter: { title: "Our Network of Partners — FinalExpense.support" },
};
...
export default function OurNetworkOfPartnersPage() {
  return (
    <LegalPage title="Our Network of Partners" updated="September 24, 2026">
      <p>
        FinalExpense.support is operated by {siteConfig.legalEntity}. When you submit a request on
