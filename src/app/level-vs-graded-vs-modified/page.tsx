...
export const metadata: Metadata = {
  ...
  description:
    "A caring, side-by-side look at the three ways a final expense death benefit can be structured, plus what happens when none of them fit.",
  openGraph: { title: "Level vs. Graded vs. Modified Life Insurance", description: "A caring, side-by-side look at the three ways a final expense death benefit can be structured, plus what happens when none of them fit." },

  twitter: { title: "Level vs. Graded vs. Modified Life Insurance", description: "A caring, side-by-side look at the three ways a final expense death benefit can be structured, plus what happens when none of them fit." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
          The three ways your family&apos;s payout can be structured
        </h1>
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          When you apply for final expense coverage, the health questions
          on your application sort you into one of a small number of
          outcomes — and that outcome decides when your family actually
          receives the full death benefit. Here&apos;s a quick side-by-side
          of the three main outcomes, plus the fourth path that exists for
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Every simplified-issue policy — meaning no medical exam, just
          health questions — is structured one of these three ways. The
          difference only matters if death occurs from natural causes
          during a carrier-set initial window, commonly the first two
          years of the policy; after that window, all three pay the exact
          same thing.
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-mist bg-canvas-alt p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            For a death by accident, the full benefit is generally paid
            immediately under any of the three outcomes, no matter how new
            the policy is. The waiting window only ever applies to death
            from natural causes — it isn&apos;t a delay on the policy as a
            whole.
          </p>
        </div>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Underwriters are mainly weighing two things: how stable and
          well-managed your health is right now, and how recent or severe
          anything more serious in your history is. A condition that&apos;s
          controlled, treated, and hasn&apos;t required a recent
          hospitalization tends to move toward level. Something more
          recent, or still being stabilized, tends to move toward graded or
          modified. On top of that, every carrier sets its own health
          questions and its own look-back period for how far back it asks
          about a diagnosis — so the same person can land in a different
          tier depending entirely on which carrier reviews the
          application.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Some health histories fall outside what a given carrier is
          willing to offer through simplified issue at all — that&apos;s a
          decline, and it&apos;s specific to that one carrier, not a
          verdict on your eligibility everywhere. Guaranteed acceptance
          exists specifically as the backstop for this situation: it skips
          health questions entirely and takes applicants within the
          eligible age range regardless of health history, in exchange for
          a two-year waiting period on natural-cause death. It&apos;s a
          different track from the three outcomes above, and it&apos;s
          covered in full in{" "}
