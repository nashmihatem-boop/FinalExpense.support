...
export const metadata: Metadata = {
  ...
  description:
    "Already have a final expense or life insurance policy? Find caring help with claims, beneficiaries, missed payments, cash value, and more.",
  openGraph: { title: "Managing Your Policy", description: "Already have a final expense or life insurance policy? Find caring help with claims, beneficiaries, missed payments, cash value, and more." },

  twitter: { title: "Managing Your Policy", description: "Already have a final expense or life insurance policy? Find caring help with claims, beneficiaries, missed payments, cash value, and more." },
};
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
          Already have a policy? We&apos;re here for that too
        </h1>
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          This section isn&apos;t about shopping for coverage — it&apos;s
          for families who already have a final expense or life insurance
          policy and need help with something specific: a missed payment, a
          claim, an outdated beneficiary, or a question about how the
          policy actually works. Pick a topic below.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          If you don&apos;t have a policy yet and you&apos;re trying to
          find one, this isn&apos;t the right section — head back to the
          homepage to compare options, or, if a health condition is part of
          what you&apos;re weighing, see our{" "}
