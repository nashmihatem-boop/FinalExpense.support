...
export const metadata: Metadata = {
  ...
  description:
    "A gentle, honest guide to how simplified-issue underwriting treats common health conditions, what level/graded/modified/guaranteed-acceptance mean, and how to find your likely path before you apply.",
  openGraph: { title: "Final Expense Insurance with Pre-Existing Conditions", description: "A gentle, honest guide to how simplified-issue underwriting treats common health conditions, what level/graded/modified/guaranteed-acceptance mean, and how to find your likely path before you apply." },

  twitter: { title: "Final Expense Insurance with Pre-Existing Conditions", description: "A gentle, honest guide to how simplified-issue underwriting treats common health conditions, what level/graded/modified/guaranteed-acceptance mean, and how to find your likely path before you apply." },
};
...
const TOC = [
  ...
  { id: "where-conditions-land", label: "Where common conditions typically land" },
  ...
  { id: "how-to-prepare", label: "How to know your path before you apply" },
...
const FAQS = [
  {
    q: "I take several medications every day. Does that rule me out?",
  ...
  {
    q: "One company said no. Does that mean every carrier will?",
    a: "Not usually. Carriers set their own rules and look-back periods, so a decline from one often isn't a decline everywhere. Guaranteed acceptance is also always there as a backstop, since it doesn't ask health questions at all.",
  },
  {
  ...
  {
    q: "Will we wait two years for coverage if I have something common like diabetes?",
    a: "Not necessarily. Many common, well-managed conditions — including a lot of diabetes cases — qualify for simplified issue with day-one coverage. The two-year wait is specifically a feature of guaranteed acceptance, a different, separate path.",
  },
  {
    q: "Do I need to mention a condition if I feel fine right now?",
    ...
    <div className="bg-canvas">
      <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h1 className="mt-3 font-display text-3xl font-extrabold text-harbor sm:text-4xl">
          A health condition doesn&apos;t have to close this door
        </h1>
        <p className="mt-6 text-lg leading-relaxed text-charcoal/80">
          Most people with a pre-existing condition still qualify for final
          expense insurance — sometimes at the best available rate, sometimes
          through a plan built for a harder health history. This guide walks
          through how carriers actually evaluate your health, where common
          conditions typically land, and how to get a sense of your likely
          path before you ever apply.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Almost every application with a health condition comes down to one
          fork in the road: simplified issue or guaranteed acceptance.
          Simplified issue is the path most families start on, and it&apos;s
          the focus of this guide — guaranteed acceptance runs on a
          different, simpler set of rules and gets its own explanation below.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Simplified issue means no medical exam — no nurse visit, no
          bloodwork. Instead, you answer a short list of yes-or-no health
          questions, typically under a dozen. The carrier also runs a couple
          of quiet background checks to confirm your answers — a look at your
          prescription history, and a check against the MIB, a shared
          industry database of past insurance applications. A decision often
          comes back the same day or within a few business days.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          It&apos;s worth aiming for: when your answers clear, coverage is
          &quot;level&quot; — the full death benefit is in place from day
          one, and simplified issue typically costs less than guaranteed
          acceptance for the same amount of coverage.
        </p>
        <div className="mt-6 rounded-2xl border border-mist bg-canvas-alt p-6">
          ...
          <p className="mt-2 text-sm leading-relaxed text-charcoal/75">
            &quot;No exam&quot; and &quot;no health questions&quot; are not
            the same thing. &quot;No exam&quot; usually means simplified
            issue — health questions still apply. &quot;No health
            questions&quot; means guaranteed acceptance, which always carries
            a two-year waiting period. Be cautious of anyone promising both no
            health questions and no waiting period at once — that combination
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Reviewing your health answers isn&apos;t a simple yes-or-no —
          carriers sort applicants into one of a few outcomes that decide when
          your family actually receives the full death benefit.
        </p>
        ...
        <p className="mt-4 text-sm leading-relaxed text-charcoal/60">
          Accidental death is generally paid in full immediately under graded
          or modified plans — the waiting period only applies to
          natural-cause death. A decline from one carrier usually just means
          guaranteed acceptance (or a different carrier) is the next step, not
        ...
        <h2 id="where-conditions-land" className="mt-14 scroll-mt-24 font-display text-2xl font-extrabold text-harbor">
          Where common conditions typically land
        </h2>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          These are general, typical patterns — not guarantees. Every carrier
          draws its own lines, which is exactly why the same condition can
          get a different answer from a different company.
        </p>
        {grouped.map((g) => (
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A quick-reference index of the conditions we cover — tap any of them
          for a closer look. As above, these are typical outcomes, not
          promises.
        </p>
        <div className="mt-6 overflow-x-auto rounded-2xl border border-mist">
          <table className="w-full min-w-[560px] border-collapse text-left">
        ...
        <p className="mt-4 text-sm leading-relaxed text-charcoal/60">
          Don&apos;t see your exact situation, or been declined before? That
          doesn&apos;t mean you&apos;re out of options — a different
          carrier&apos;s rules, or the guaranteed-issue path, very often still
          has a place for you.
        </p>
        ...
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Two carriers can look at the exact same person and land in
          different places — one says level, another says graded. That&apos;s
          not a glitch; it&apos;s how this market is built, and it can work in
          your favor if you know how to use it.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Carriers don&apos;t share one rulebook. Each sets its own health
          questions, its own look-back periods (how far back it asks about a
          diagnosis or treatment), and its own list of medications it will and
          won&apos;t accept. A treatment from three years ago might fall
          outside one carrier&apos;s two-year look-back but inside
          another&apos;s four-year window — and that single difference can
          decide your tier.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Because of this, applying to just one carrier and accepting its
          answer can leave real money — or a better tier — on the table. This
          is exactly where working with an agency that knows the market helps:
          matching your specific history to the carrier whose rules are
          friendliest to it, before an application ever gets submitted.
        </p>
        ...
        <h2 id="how-to-prepare" className="mt-14 scroll-mt-24 font-display text-2xl font-extrabold text-harbor">
          How to know your path before you apply
        </h2>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          A little preparation goes a long way. Before you apply, it helps to
          have a clear picture ready: each condition and when it was
          diagnosed, when you were last treated or hospitalized for it, and a
          complete, current medication list. Carriers check your prescription
          history against your answers, so an accurate list avoids surprises.
        </p>
        <p className="mt-4 text-base leading-relaxed text-charcoal/80">
          Answer every question honestly. A mismatch between your answers and
          your records — discovered during the early contestability period —
          can put your family&apos;s claim at risk later. If a knockout
          condition like current oxygen use, dialysis, or active cancer
          treatment applies to you, guaranteed acceptance is likely the more
          direct path, not a last resort.
        </p>
